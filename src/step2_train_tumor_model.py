'''
Description:
    This script trains tumor-other tiles classifier OR WDA-PDA-other tiles classifier
Author:
...
data0 = []
data1 = []
data2 = []  # this list should be empty if tumor-other tiles classifier needed
...
for i in range(len(data2)):
    if 0 <= i % 200 < 170:
        train_set.append((data2[i], 2))
    if 170 <= i % 200 < 195:
        validation_set.append((data2[i], 2))
    if 195 <= i % 200 < 200:
        test_set.append((data2[i], 2))
...
if __name__ == '__main__':
    ...
    test()
    print("start saving!")
    torch.save(net, "../models/tumor"+'.model')
